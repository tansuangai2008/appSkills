...
import com.example.photoalbum.common.util.file.AttachmentStore;
import com.example.photoalbum.common.util.file.FileUtil;
...
public class ImageUtil {
    ...
    public static String makeThumbnail(File imageFile) {
        ...
        boolean result = scaleThumbnail(imageFile, thumbFile, getImageMaxEdge(),
                getImageMinEdge(), CompressFormat.JPEG, 60);
        if (!result) {
