package com.example.photoalbum.common.activity;
...
import com.example.photoalbum.common.util.sys.ReflectionUtil;
...
public abstract class UI extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Log.v(TAG, "activity: " + getClass().getSimpleName() + " onCreate()");
    }
    ...
    protected void onDestroy() {
        super.onDestroy();
        Log.v(TAG,"activity: " + getClass().getSimpleName() + " onDestroy()");
        destroyed = true;
    }
