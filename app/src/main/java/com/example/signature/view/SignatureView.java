package com.example.signature.view;
...
/**
 * author : ly
 * date : 2020/9/16 13:37
 * description : 实现android 手势签名
 */
public class SignatureView extends View {
    ...
    protected void onSizeChanged(int w, int h, int oldw, int oldh) {
        ...
        Log.e(TAG,"onSizeChanged onSizeChanged onSizeChanged");
        cachebBitmap = Bitmap.createBitmap(getMeasuredWidth(), getMeasuredHeight(), Bitmap.Config.ARGB_8888);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        Log.e(TAG,"onDraw onDraw onDraw");
    }
